...
class PlayerModelTests(unittest.TestCase):
    ...
    def test_create_player_record_time_dilation_charges(self):
        self.assertEqual(create_player_record("Pilot")["time_dilation_charges"], 0)
        self.assertEqual(create_player_record("Pilot", time_dilation_charges=2)["time_dilation_charges"], 2)
        self.assertEqual(create_player_record("Pilot", time_dilation_charges=True)["time_dilation_charges"], 0)
